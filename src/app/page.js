      ...
      {activeModal === 'signin' && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-auto">
            {/* Header */}
            <div className="bg-yellow-400 rounded-t-2xl p-6 text-center relative">
              <button
                onClick={closeModal}
            ...
            <div className="p-6">
              <div className="text-center mb-6">
                <p className="text-gray-600 mb-4">Continue with your Google account</p>
                <button
                  onClick={handleGoogleSignIn}
                  disabled={loading}
                  className="w-full bg-white border-2 border-gray-200 hover:border-emerald-300 rounded-full py-3 px-4 flex items-center justify-center gap-3 transition-all duration-200 hover-zoom disabled:opacity-50"
                >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-auto">
            ...
            <div className="bg-yellow-400 rounded-t-2xl p-6 text-center relative">
              ...
              <h2 className="text-2xl font-bold text-emerald-700">Join Frame!</h2>
            ...
            <div className="p-6">
              <div className="text-center mb-6">
                <p className="text-gray-600 mb-4">Get started with your Google account</p>
                <button
                  onClick={handleGoogleSignIn}
                  disabled={loading}
                  className="w-full bg-emerald-700 hover:bg-emerald-800 text-white rounded-full py-3 px-4 flex items-center justify-center gap-3 transition-all duration-200 hover-zoom disabled:opacity-50"
                >
                  <svg className="w-5 h-5" viewBox="0 0 24 24">
