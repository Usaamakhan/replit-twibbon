              ...
              <div className="p-6">
                ...
                <form className="space-y-4 mb-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 border border-gray-300 rounded-full focus:ring-2 focus:ring-emerald-500 focus:border-transparent outline-none transition-all"
                    />
                  </div>
                  <div>
                  ...
                  <button
                    type="button"
                    className="w-full bg-emerald-700 hover:bg-emerald-800 text-white rounded-full py-3 px-4 font-medium transition-all duration-200 hover-zoom"
                  >
                    Sign In
                  </button>
                </form>
                ...
                <div className="text-center mb-6">
                  <button
                    ...
                    disabled={loading}
                    className="w-full bg-white border-2 border-gray-200 hover:border-emerald-300 rounded-full py-3 px-4 flex items-center justify-center gap-3 transition-all duration-200 hover-zoom disabled:opacity-50 text-gray-700"
                  >
