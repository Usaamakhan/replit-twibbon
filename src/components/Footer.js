          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-col gap-3">
                <button className="flex items-center justify-center px-3 py-2 bg-black text-white rounded-lg hover:bg-gray-800 transition-colors duration-200 w-full sm:w-auto">
                  ...
                  <div className="text-left min-w-0">
                    ...
                    <div className="text-sm font-semibold truncate">Google Play</div>
                  </div>
                </button>
                ...
                <button className="flex items-center justify-center px-3 py-2 bg-black text-white rounded-lg hover:bg-gray-800 transition-colors duration-200 w-full sm:w-auto">
                  ...
                  <div className="text-left min-w-0">
                    ...
                    <div className="text-sm font-semibold truncate">App Store</div>
                  </div>
                </button>
              </div>
            </div>
