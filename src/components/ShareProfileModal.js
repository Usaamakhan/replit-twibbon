...
export default function ShareProfileModal({ isOpen, onClose, profileUrl, displayName, username, profileImage }) {
  ...
  const handleShareTwitter = () => {
    const twitterText = `Check out ${displayName}'s profile on Twibbonize!`;
  ...
  const handleShareEmail = () => {
    const subject = `Check out ${displayName}'s profile`;
    const body = `I thought you might be interested in ${displayName}'s profile on Twibbonize: ${profileUrl}`;
    ...
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        ...
        >
          ...
          <div className="text-center mb-6">
            {profileImage ? (
              <img
                src={profileImage}
                alt={displayName}
                className="w-20 h-20 rounded-full mx-auto mb-3 object-cover border-4 border-gray-100"
              />
            ) : (
              <div className="w-20 h-20 rounded-full mx-auto mb-3 bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center border-4 border-gray-100">
          ...
          <div className="mb-6">
            <h4 className="text-center text-gray-700 font-medium mb-4">Share to your social media</h4>
