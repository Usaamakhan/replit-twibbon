          ...
          <nav className="space-y-1">
            ...
            {user && (
              <div className="py-3 px-4">
                <a 
                  href="#" 
                  className="inline-flex items-center gap-3 py-2 px-3 text-lg font-normal text-gray-800 hover:bg-emerald-50 hover:text-emerald-700 rounded-lg transition-colors duration-200"
                >
